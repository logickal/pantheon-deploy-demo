  ...
  return (
    <div className="relative w-24 h-24 mx-auto">
      ...
      <div className="relative w-full h-full rounded-xl border-2 border-[#5F41E5] bg-gradient-to-br from-[#23232D] to-[#3017A1] overflow-hidden">
        {/* Filling animation from bottom to top */}
        ...
        {/* Sparkle particles - Star Trek transporter style */}
        ...
        {/* Glow effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#FFDC28]/30 via-transparent to-[#5F41E5]/30 blur-xl opacity-60 animate-pulse"></div>
      </div>
